...
{    
    public static class ObjectExtension
    {
        ...
        public static string ToQueryString(this object metaToken)
        {
            var keyValueContent = metaToken.ToKeyValue();
            var formUrlEncodedContent = new FormUrlEncodedContent(keyValueContent);
            var urlEncodedString = formUrlEncodedContent.ReadAsStringAsync();

            return urlEncodedString.Result;
        }

        public static string WithQueryString(this string url, object metaToken)
        {
            if (metaToken != null)
            {
                url += metaToken.ToQueryString();
            }
